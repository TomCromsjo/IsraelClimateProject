...
do "scripts/process_mesurments.do" // Creates daily_weather.dta and merged_hourly_wind.dta using IMS mesurments. 
do "scripts/distance_matrix.do" // Creates a distance matrix between each weather-station in station_data.dta and each locality in yeshov_list.dta
do "scripts/weather_averages.do" // Creates distance weighted averages of weather variables for each locality and dae between 1990-2020
